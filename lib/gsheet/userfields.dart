...
class UserFields {
  ...
  Future<void> inputdata() async {
    ...
    await _usersheet.values.insertValue('TEST', column: count + 3, row: count);
    await _usersheet.values.insertValue('SALES', column: count + 4, row: count);
    await _usersheet.values.insertValue('RATE', column: count + 5, row: count);
    await _usersheet.values.insertValue('TOTAL', column: count + 6, row: count);
    ...
    await _usersheet.values
        .insertValue(a2closinig, column: count + 2, row: count + 7);
    await _usersheet.values
        .insertValue(a2opening, column: count + 2, row: count + 7);
    await _usersheet.values
